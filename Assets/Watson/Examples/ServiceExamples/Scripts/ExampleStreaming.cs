...
public class ExampleStreaming : MonoBehaviour
{
    ...
    [SerializeField]
    private string _iamApikey = "<S9SSE-tfYm82yZVi9S1hG1SciGeKUVdCUK8-YueUyre9>";
    [Tooltip("The IAM url used to authenticate the apikey (optional). This defaults to \"https://iam.bluemix.net/identity/token\".")]
    [SerializeField]
    private string _iamTokenUrl = "https://iam.bluemix.net/identity/token";
    ...
    {
        Log.Debug("ExampleStreaming.text", text);
        return text;
    }
    ...
    public void OnRecognize(SpeechRecognitionEvent result, Dictionary<string, object> customData)
    {
